<p align="center">
  <img src="assets/images/EcoPayIcon.png" width="120" alt="EcoPay Logo"/>
</p>

<h1 align="center">🌱 EcoPay: Sustainable Spending Made Simple</h1>

<p align="center">
  <strong>EcoPay</strong> is a sustainability-focused plugin built with <img src="https://img.shields.io/badge/Flutter-3.x-blue?logo=flutter" alt="Flutter badge" /> for seamless integration into e-wallets like <strong>Touch ‘n Go (TnG)</strong>.
</p>

<p align="center">
  Helping <strong>Gen Z Malaysians</strong> track carbon footprint, make greener decisions, and support verified causes—right within their daily payment experience.
</p>

<p align="center">
  <a href="#-features-summary"><img alt="Features" src="https://img.shields.io/badge/Features-Green%20Tracker%20%7C%20Gamification%20%7C%20Donations-4CAF50" /></a>
  <a href="#-target-audience-why-gen-z"><img alt="Target Audience" src="https://img.shields.io/badge/Target%20Gen%20Z-MY%20Youth%20Focus-03A9F4" /></a>
  <a href="#-architecture"><img alt="Architecture" src="https://img.shields.io/badge/Architecture-Modular%20%2B%20Scalable-673AB7" /></a>
</p>
...
EcoPay is a **modular SDK** designed for integration into Malaysian e-wallets, bringing **real-time environmental impact tracking**, **gamified sustainability**, and **automated micro-donations** to the everyday consumer. It transforms your e-wallet into a **green personal finance coach**—with **zero friction**.

> 💡 Built for **PayHack25 Challenge 3 – ESG/Sustainability**:
>
> _“How can digital payments be leveraged to seamlessly integrate environmental sustainability and social impact into daily transactions?”_
